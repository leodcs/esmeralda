...
RSpec.describe Parser do
  ...
  it 'Detecta símbolos inesperados' do
    files = [
      ...
      ['erro2_condicional', 'ERRO 02: Símbolo "X" inesperado. Esperando "(" - Linha 4, Coluna 6.'],
      ...
      ['erro2_multi_op_relacional', 'ERRO 02: Símbolo "NOT" inesperado. Esperando ")" - Linha 4, Coluna 15.'],
